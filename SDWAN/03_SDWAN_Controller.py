#Display all available controllers—vBond orchestrators, vManage NMS, and vSmart controllers—in the overlay network.
...
print(json.dumps(getController(), indent=2))