...
#DELETE LOOPBACK CONFIGURED, NEED TO MAKE SURE XML TAG FOR NC SPECIFICALLY IS LISTED OR ELSE ITLL SPIT OUT ERROR THAT A NAMESPACE WAS NOT DEFINED FOR NC OPERATION (LINE 23)
