...
def getNetwork():
    API_URI = '/dna/intent/api/v1/network'
...
def getDeviceCredentialDetails():
    API_URI = '/dna/intent/api/v1/device-credential'
    BASE_URI = 'https://sandboxdnac2.cisco.com'
    HEADERS = {
        'X-Auth-Token': getToken(),
        'Content-Type': 'application/json',
...
print(json.dumps(getDeviceCredentialDetails(), indent=2))